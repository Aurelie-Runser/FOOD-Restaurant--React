...
export default function Chargement() {
    const styleLoading = {display: 'block', margin: 'auto'}
    
  return <svg style={styleLoading} xmlns="http://www.w3.org/2000/svg"
    width="70" height="70" viewBox="0 0 24 24">
        <circle cx="4" cy="12" r="3" fill="#F48E28">
        ...
        <circle cx="12" cy="12" r="3" fill="#F48E28">
        ...
        <circle cx="20" cy="12" r="3" fill="#F48E28">
